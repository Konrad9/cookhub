...
from cookhub.views import Homepage, EditProfileView, ProfileView, RecipeView, EditRecipeView, SaveRecipeView
...
urlpatterns = [
    ...
    path("save_recipe/", SaveRecipeView.as_view(), name="save_recipe"),
